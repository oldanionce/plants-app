        ...
        <>
			<div class="modalContent">			
				<div class='modalImage'>
					...
					<ul>
						<li class='card__carelevel'><h4>Care Level: </h4> {careLevelInfo}</li>
						<li>{petFriendly === true ? <span className="altIcons" title="Pet Friendly">{petFriendlyIcon}</span> : ""}</li>
					</ul>
				</div>
				<div class='modalInfo'>
					...
					<ul>
						<li class="plantLocation">
							<p>
								{interiorExterior !== 1 ? 
								(interiorExterior === 2 ? <span className="altIcons" title="Exterior">{locationExteriorIcon}</span> : 
								<span className="altIcons" title="Interior &amp; Exterior">{locationInteriorIcon}{locationExteriorIcon}</span>): 
								<span className="altIcons" title="Interior">{locationInteriorIcon}</span>}
								{location}
							</p>
						</li>
						<li class="plantIrrigation">
							<span className="altIcons" title="Irrigation">{irrigationIcon}</span>
							<span>{
								{
								1: 'Once a month',
								2: 'Once a week',
						...
						<li><span className="altIcons" title="Soil">{soilIcon}</span>{soil}</li>
					</ul>					
				</div>	
			</div>
			<SaveToMyPlantsForm></SaveToMyPlantsForm>
		</>
	);
}